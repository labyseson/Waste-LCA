...
### Accounting method 1: including biogenic CO2
...
waste_2$E1_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$E1_tech
...
waste_2$E1_netemiss <- waste_2$E1_collectionemiss + waste_2$E1_transport1emiss + waste_2$E1_processemiss + waste_2$E1_enduseemiss + waste_2$E1_bioco2emiss + waste_2$E1_dispemiss
...
waste_2$E2_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$E2_tech
...
waste_2$E2_netemiss <- waste_2$E2_collectionemiss + waste_2$E2_transport1emiss + waste_2$E2_processemiss + waste_2$E2_enduseemiss + waste_2$E2_bioco2emiss + waste_2$E2_dispemiss
...
waste_2$E3_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$E3_tech
...
waste_2$E3_netemiss <- waste_2$E3_collectionemiss + waste_2$E3_transport1emiss + waste_2$E3_processemiss + waste_2$E3_enduseemiss + waste_2$E3_bioco2emiss + waste_2$E3_dispemiss
...
waste_2$E4_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$E4_tech
...
waste_2$E4_netemiss <- waste_2$E4_collectionemiss + waste_2$E4_transport1emiss + waste_2$E4_processemiss + waste_2$E4_enduseemiss + waste_2$E4_bioco2emiss + waste_2$E4_dispemiss
...
waste_2$M1_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$M1_tech
waste_2$M1_dispemiss <- 0 - waste_2$M1_energy* waste_2$NG_GHG
waste_2$M1_dispemissmain <- waste_2$M1_dispemiss
waste_2$M1_netemiss <- waste_2$M1_collectionemiss + waste_2$M1_transport1emiss + waste_2$M1_processemiss + waste_2$M1_transport2emiss + waste_2$M1_enduseemiss + waste_2$M1_bioco2emiss + waste_2$M1_dispemiss
...
waste_2$M2_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$M2_tech
waste_2$M2_dispemiss <- 0 - waste_2$M2_energy* waste_2$NG_GHG
waste_2$M2_dispemissmain <- waste_2$M2_dispemiss
waste_2$M2_netemiss <- waste_2$M2_collectionemiss + waste_2$M2_transport1emiss + waste_2$M2_processemiss + waste_2$M2_transport2emiss + waste_2$M2_enduseemiss + waste_2$M2_bioco2emiss + waste_2$M2_dispemiss
...
waste_2$Eth1_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$Eth1_tech
...
waste_2$Eth1_netemiss <- waste_2$Eth1_collectionemiss + waste_2$Eth1_transport1emiss + waste_2$Eth1_processemiss + waste_2$Eth1_transport2emiss + waste_2$Eth1_enduseemiss + waste_2$Eth1_bioco2emiss + waste_2$Eth1_dispemiss
...
waste_2$Rd1_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$Rd1_tech
...
waste_2$Rd1_dispemissco <- 0 - waste_2$Rd1_g * waste_2$Gasoline_GHG -  waste_2$Rd1_j * waste_2$Jet_GHG -
                            waste_2$Rd1_m * waste_2$NG_GHG - waste_2$Rd1_elec * waste_2$Powergen_GHG 
waste_2$Rd1_netemiss <- waste_2$Rd1_collectionemiss + waste_2$Rd1_transport1emiss + waste_2$Rd1_processemiss + waste_2$Rd1_enduseemiss + waste_2$Rd1_transport2emiss + waste_2$Rd1_bioco2emiss + waste_2$Rd1_dispemiss
...
waste_2$Rd2_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$Rd2_tech
...
waste_2$Rd2_netemiss <- waste_2$Rd2_collectionemiss + waste_2$Rd2_transport1emiss + waste_2$Rd2_processemiss + waste_2$Rd2_transport2emiss + waste_2$Rd2_enduseemiss + waste_2$Rd2_bioco2emiss + waste_2$Rd2_dispemiss
...
waste_2$Bj1_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$Bj1_tech
...
waste_2$Bj1_netemiss <- waste_2$Bj1_collectionemiss + waste_2$Bj1_transport1emiss + waste_2$Bj1_processemiss + waste_2$Bj1_transport2emiss + waste_2$Bj1_enduseemiss + waste_2$Bj1_bioco2emiss + waste_2$Bj1_dispemiss
...
waste_2$Bj2_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$Bj2_tech
waste_2$Bj2_dispemiss <- 0 - waste_2$Bj2_energy * waste_2$Jet_GHG 
waste_2$Bj2_dispemissmain <- waste_2$Bj2_dispemiss
waste_2$Bj2_netemiss <- waste_2$Bj2_collectionemiss + waste_2$Bj2_transport1emiss + waste_2$Bj2_processemiss + waste_2$Bj2_transport2emiss + waste_2$Bj2_enduseemiss + waste_2$Bj2_bioco2emiss + waste_2$Bj2_dispemiss
...
waste_2$Bj3_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$Bj3_tech
...
waste_2$Bj3_netemiss <- waste_2$Bj3_collectionemiss + waste_2$Bj3_transport1emiss + waste_2$Bj3_processemiss + waste_2$Bj3_transport2emiss + waste_2$Bj3_enduseemiss + waste_2$Bj3_bioco2emiss + waste_2$Bj3_dispemiss
...
waste_2$Bj4_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$Bj4_tech
...
waste_2$Bj4_netemiss <- waste_2$Bj4_collectionemiss + waste_2$Bj4_transport1emiss + waste_2$Bj4_processemiss + waste_2$Bj4_transport2emiss+ waste_2$Bj4_enduseemiss + waste_2$Bj4_bioco2emiss + waste_2$Bj4_dispemiss
...
waste_2$Bj5_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$Bj5_tech
...
waste_2$Bj5_netemiss <- waste_2$Bj5_collectionemiss + waste_2$Bj5_transport1emiss + waste_2$Bj5_processemiss + waste_2$Bj5_transport2emiss + waste_2$Bj5_enduseemiss + waste_2$Bj5_bioco2emiss + waste_2$Bj5_dispemiss
...
waste_2$Bj6_bioco2emiss <- waste_2$Prod_ww * waste_2$Bio_emiss * waste_2$Bj6_tech
...
waste_2$Bj6_netemiss <- waste_2$Bj6_collectionemiss + waste_2$Bj6_transport1emiss + waste_2$Bj6_processemiss + waste_2$Bj6_transport2emiss + waste_2$Bj6_enduseemiss + waste_2$Bj6_bioco2emiss + waste_2$Bj6_dispemiss
...
waste_emiss_US <- subset(waste_2, select = c(Waste_type, Prod_ww, 
                                      E1_collectionemiss, E1_transport1emiss, E1_processemiss, E1_dispemissmain, E1_dispemissco, E1_netemiss, E1_enduseemiss, E1_bioco2emiss,
                                      E2_collectionemiss, E2_transport1emiss, E2_processemiss, E2_dispemissmain, E2_dispemissco, E2_netemiss, E2_enduseemiss, E2_bioco2emiss,
                                      E3_collectionemiss, E3_transport1emiss, E3_processemiss, E3_dispemissmain, E3_netemiss, E3_enduseemiss, Bj5_bioco2emiss, E3_bioco2emiss,
                                      E4_collectionemiss, E4_transport1emiss, E4_processemiss, E4_dispemissmain, E4_dispemissco, E4_netemiss, E4_enduseemiss, E4_bioco2emiss,
                                      M1_collectionemiss, M1_transport1emiss, M1_processemiss, M1_dispemissmain, M1_netemiss, M1_enduseemiss, M1_bioco2emiss, 
                                      M2_collectionemiss, M2_transport1emiss, M2_processemiss, M2_dispemissmain, M2_netemiss, M2_enduseemiss, M2_bioco2emiss,
                                      Eth1_collectionemiss, Eth1_transport1emiss, Eth1_processemiss, Eth1_transport2emiss, Eth1_dispemissmain, Eth1_dispemissco, Eth1_netemiss, Eth1_enduseemiss, Eth1_bioco2emiss,
                                      Rd1_collectionemiss, Rd1_transport1emiss, Rd1_processemiss, Rd1_transport2emiss, Rd1_dispemissmain, Rd1_dispemissco, Rd1_netemiss, Rd1_enduseemiss, Rd1_bioco2emiss,
                                      Rd2_collectionemiss, Rd2_transport1emiss, Rd2_processemiss, Rd2_transport2emiss, Rd2_dispemissmain, Rd2_dispemissco, Rd2_netemiss, Rd2_enduseemiss, Rd2_bioco2emiss,
                                      Bj1_collectionemiss, Bj1_transport1emiss, Bj1_processemiss, Bj1_transport2emiss, Bj1_dispemissmain, Bj1_dispemissco, Bj1_netemiss, Bj1_enduseemiss, Bj1_bioco2emiss,
                                      Bj2_collectionemiss, Bj2_transport1emiss, Bj2_processemiss, Bj2_transport2emiss, Bj2_dispemissmain, Bj2_netemiss, Bj2_enduseemiss, Bj2_bioco2emiss, 
                                      Bj3_collectionemiss, Bj3_transport1emiss, Bj3_processemiss, Bj3_transport2emiss, Bj3_dispemissmain, Bj3_dispemissco, Bj3_netemiss, Bj3_enduseemiss, Bj3_bioco2emiss,
                                      Bj4_collectionemiss, Bj4_transport1emiss, Bj4_processemiss, Bj4_transport2emiss, Bj4_dispemissmain, Bj4_dispemissco, Bj4_netemiss, Bj4_enduseemiss, Bj4_bioco2emiss,
                                      Bj5_collectionemiss, Bj5_transport1emiss, Bj5_processemiss, Bj5_transport2emiss, Bj5_dispemissmain, Bj5_dispemissco, Bj5_netemiss, Bj5_enduseemiss, Bj5_bioco2emiss,
                                      Bj6_collectionemiss, Bj6_transport1emiss, Bj6_processemiss, Bj6_transport2emiss, Bj6_dispemissmain, Bj6_dispemissco, Bj6_netemiss, Bj6_enduseemiss, Bj6_bioco2emiss))

waste_emiss_US <- aggregate(.~Waste_type, waste_emiss_US, sum)
waste_emiss_US_1 <- gather(waste_emiss_US, category, emiss_kg, E1_collectionemiss:Bj6_bioco2emiss)
...
waste_emiss_US_1$Stage <- factor(waste_emiss_US_1$Stage, 
                        levels = c("collection", "transport1","process","transport2", "dispmain", "dispco", "net", "enduse", "bioco2"))
waste_emiss_US_2 <- subset(waste_emiss_US_1, waste_emiss_US_1$Stage != "net")
waste_emiss_US_3 <- rbind(waste_emiss_US_2, current1)
...
waste_emiss_fs_1 <- gather(waste_emiss_fs, category, emiss_kg, E1_collectionemiss:Bj6_bioco2emiss)
...
County_FOLDER <- "figures_withbioCO2"
...
#ggsave(paste(County_FOLDER, "/energy_bioCO2.png", sep=""), plot=p, width=18.5,height=4.5,units="in",dpi=300)
ggsave(paste(County_FOLDER, "/energy_bioCO2.pdf", sep=""), plot=p, width=18.5,height=4.5,units="in")
...
p <- ggplot()+ 
  ...
  theme(plot.title = element_text(face = "bold", size = 24, hjust = 0))
#ggsave(paste(County_FOLDER, "/eroi_bioCO2.png", sep=""), plot=p, width=18.5,height=4.5,units="in",dpi=300)
ggsave(paste(County_FOLDER, "/eroi_bioCO2.pdf", sep=""), plot=p, width=18.5,height=4.5,units="in")
...
p <- ggplot()+ 
  ...
  theme_bw() +
  theme(text = element_text(size=20)) +
  scale_fill_manual(values=colors_stage, breaks=c("collection", "transport1","process","transport2", "enduse", "bioco2", "dispmain", "dispco", "net", "all"),
                    labels = c("Collection", "Transport to facility", "Processing", 
                               "Transmission & Distribution", "Enduse", "Biogenic CO2", "Displacement/main product", "Displacement/co-product(s)","Net GWP", "Current management practices")) +
  ...
  facet_grid(~Waste_type, scales = "free_x", space = "free_x")+
  theme(strip.background =element_rect(fill="white"), strip.text = element_text(size = 20, face = "bold"))+
  ggtitle("(c) GWP - including biogenic CO2") +
  theme(plot.title = element_text(face = "bold", size = 24, hjust = 0))
ggsave(paste(County_FOLDER, "/emiss_by_stage_bioCO2.png", sep=""), plot=p, width=20.5,height=6,units="in",dpi=300)
#ggsave(paste(County_FOLDER, "/emiss_by_stage_bioCO2.pdf", sep=""), plot=p, width=20.5,height=6,units="in")
...
p <- ggplot()+ 
  ...
  facet_grid(~Waste_type, scales = "free_x", space = "free_x")+
  theme(strip.background =element_rect(fill="white"), strip.text = element_text(size = 20, face = "bold"))+
  ggtitle("(d) GWP - including biogenic CO2") +
  theme(plot.title = element_text(face = "bold", size = 24, hjust = 0))
ggsave(paste(County_FOLDER, "/emiss_by_stage_bioCO2_1.png", sep=""), plot=p, width=20.5,height=6,units="in",dpi=300)
#ggsave(paste(County_FOLDER, "/emiss_by_stage_bioCO2_1.pdf", sep=""), plot=p, width=20.5,height=6,units="in")
...
p <- ggplot()+ 
  ...
  #ggtitle("(a) Energy") +
  #theme(plot.title = element_text(face = "bold", size = 24, hjust = 0))
ggsave(paste(County_FOLDER, "/energy_fs_bioCO2.png", sep=""), plot=p, width=60,height=40,units="in",dpi=300, limitsize = FALSE)
...
p <- ggplot()+ 
  ...
  #ggtitle("(b) Energy return on investment") +
  #theme(plot.title = element_text(face = "bold", size = 24, hjust = 0))
ggsave(paste(County_FOLDER, "/eroi_fs_bioCO2.png", sep=""), plot=p, width=60,height=40,units="in",dpi=300, limitsize = FALSE)
...
p <- ggplot()+ 
  ...
  theme_bw() +
  theme(text = element_text(size=32)) +
  scale_fill_manual(values=colors_stage, breaks=c("collection", "transport1","process","transport2", "enduse", "bioco2", "dispmain", "dispco", "net"),
                    labels = c("Collection", "Transport to facility", "Processing", 
                               "Transmission & Distribution", "Enduse", "Biogenic CO2", "Displacement/main product", "Displacement/co-product(s)","Net GWP")) +
  ...
  facet_wrap(~Feedstock, scales = "free", ncol = 8)+
  theme(strip.background =element_rect(fill="white"), strip.text = element_text(size = 32, face = "bold")) 
ggsave(paste(County_FOLDER, "/emiss_by_stage_fs_bioCO2.png", sep=""), plot=p, width=60,height=40,units="in",dpi=300, limitsize = FALSE)
...
waste_2_1$E1_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$E1_tech
...
waste_2_1$E1_netemiss <- waste_2_1$E1_collectionemiss + waste_2_1$E1_transport1emiss + waste_2_1$E1_processemiss + waste_2_1$E1_enduseemiss + waste_2_1$E1_bioco2emiss + waste_2_1$E1_dispemiss
...
waste_2_1$E2_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$E2_tech
...
waste_2_1$E2_netemiss <- waste_2_1$E2_collectionemiss + waste_2_1$E2_transport1emiss + waste_2_1$E2_processemiss + waste_2_1$E2_enduseemiss + waste_2_1$E2_bioco2emiss + waste_2_1$E2_dispemiss
...
waste_2_1$E3_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$E3_tech
...
waste_2_1$E3_netemiss <- waste_2_1$E3_collectionemiss + waste_2_1$E3_transport1emiss + waste_2_1$E3_processemiss + waste_2_1$E3_enduseemiss + waste_2_1$E3_bioco2emiss + waste_2_1$E3_dispemiss
...
waste_2_1$E4_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$E4_tech
...
waste_2_1$E4_netemiss <- waste_2_1$E4_collectionemiss + waste_2_1$E4_transport1emiss + waste_2_1$E4_processemiss + waste_2_1$E4_enduseemiss + waste_2_1$E4_bioco2emiss + waste_2_1$E4_dispemiss
...
waste_2_1$M1_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$M1_tech
waste_2_1$M1_dispemiss <- 0 - waste_2_1$M1_energy* waste_2_1$NG_GHG
waste_2_1$M1_dispemissmain <- waste_2_1$M1_dispemiss
waste_2_1$M1_netemiss <- waste_2_1$M1_collectionemiss + waste_2_1$M1_transport1emiss + waste_2_1$M1_processemiss + waste_2_1$M1_transport2emiss + waste_2_1$M1_enduseemiss + waste_2_1$M1_bioco2emiss + waste_2_1$M1_dispemiss
...
waste_2_1$M2_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$M2_tech
waste_2_1$M2_dispemiss <- 0 - waste_2_1$M2_energy* waste_2_1$NG_GHG
waste_2_1$M2_dispemissmain <- waste_2_1$M2_dispemiss
waste_2_1$M2_netemiss <- waste_2_1$M2_collectionemiss + waste_2_1$M2_transport1emiss + waste_2_1$M2_processemiss + waste_2_1$M2_transport2emiss + waste_2_1$M2_enduseemiss + waste_2_1$M2_bioco2emiss + waste_2_1$M2_dispemiss
...
waste_2_1$Eth1_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$Eth1_tech
...
waste_2_1$Eth1_netemiss <- waste_2_1$Eth1_collectionemiss + waste_2_1$Eth1_transport1emiss + waste_2_1$Eth1_processemiss + waste_2_1$Eth1_transport2emiss + waste_2_1$Eth1_enduseemiss + waste_2_1$Eth1_bioco2emiss + waste_2_1$Eth1_dispemiss
...
waste_2_1$Rd1_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$Rd1_tech
...
waste_2_1$Rd1_dispemissco <- 0 - waste_2_1$Rd1_g * waste_2_1$Gasoline_GHG -  waste_2_1$Rd1_j * waste_2_1$Jet_GHG -
                             waste_2_1$Rd1_m * waste_2_1$NG_GHG - waste_2_1$Rd1_elec * waste_2_1$Powergen_GHG 
waste_2_1$Rd1_netemiss <- waste_2_1$Rd1_collectionemiss + waste_2_1$Rd1_transport1emiss + waste_2_1$Rd1_processemiss + waste_2_1$Rd1_enduseemiss + waste_2_1$Rd1_transport2emiss + waste_2_1$Rd1_bioco2emiss + waste_2_1$Rd1_dispemiss
...
waste_2_1$Rd2_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$Rd2_tech
...
waste_2_1$Rd2_netemiss <- waste_2_1$Rd2_collectionemiss + waste_2_1$Rd2_transport1emiss + waste_2_1$Rd2_processemiss + waste_2_1$Rd2_transport2emiss + waste_2_1$Rd2_enduseemiss + waste_2_1$Rd2_bioco2emiss + waste_2_1$Rd2_dispemiss
...
waste_2_1$Bj1_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$Bj1_tech
...
waste_2_1$Bj1_netemiss <- waste_2_1$Bj1_collectionemiss + waste_2_1$Bj1_transport1emiss + waste_2_1$Bj1_processemiss + waste_2_1$Bj1_transport2emiss + waste_2_1$Bj1_enduseemiss + waste_2_1$Bj1_bioco2emiss + waste_2_1$Bj1_dispemiss
...
waste_2_1$Bj2_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$Bj2_tech
waste_2_1$Bj2_dispemiss <- 0 - waste_2_1$Bj2_energy * waste_2_1$Jet_GHG 
waste_2_1$Bj2_dispemissmain <- waste_2_1$Bj2_dispemiss
waste_2_1$Bj2_netemiss <- waste_2_1$Bj2_collectionemiss + waste_2_1$Bj2_transport1emiss + waste_2_1$Bj2_processemiss + waste_2_1$Bj2_transport2emiss + waste_2_1$Bj2_enduseemiss + waste_2_1$Bj2_bioco2emiss + waste_2_1$Bj2_dispemiss
...
waste_2_1$Bj3_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$Bj3_tech
...
waste_2_1$Bj3_netemiss <- waste_2_1$Bj3_collectionemiss + waste_2_1$Bj3_transport1emiss + waste_2_1$Bj3_processemiss + waste_2_1$Bj3_transport2emiss + waste_2_1$Bj3_enduseemiss + waste_2_1$Bj3_bioco2emiss + waste_2_1$Bj3_dispemiss
...
waste_2_1$Bj4_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$Bj4_tech
...
waste_2_1$Bj4_netemiss <- waste_2_1$Bj4_collectionemiss + waste_2_1$Bj4_transport1emiss + waste_2_1$Bj4_processemiss + waste_2_1$Bj4_transport2emiss+ waste_2_1$Bj4_enduseemiss + waste_2_1$Bj4_bioco2emiss + waste_2_1$Bj4_dispemiss
...
waste_2_1$Bj5_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$Bj5_tech
...
waste_2_1$Bj5_netemiss <- waste_2_1$Bj5_collectionemiss + waste_2_1$Bj5_transport1emiss + waste_2_1$Bj5_processemiss + waste_2_1$Bj5_transport2emiss + waste_2_1$Bj5_enduseemiss + waste_2_1$Bj5_bioco2emiss + waste_2_1$Bj5_dispemiss
...
waste_2_1$Bj6_bioco2emiss <- waste_2_1$Prod_ww * waste_2_1$Bio_emiss * waste_2_1$Bj6_tech
...
waste_2_1$Bj6_netemiss <- waste_2_1$Bj6_collectionemiss + waste_2_1$Bj6_transport1emiss + waste_2_1$Bj6_processemiss + waste_2_1$Bj6_transport2emiss + waste_2_1$Bj6_enduseemiss + waste_2_1$Bj6_bioco2emiss + waste_2_1$Bj6_dispemiss
...
waste_2_2$E1_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$E1_tech
...
waste_2_2$E1_netemiss <- waste_2_2$E1_collectionemiss + waste_2_2$E1_transport1emiss + waste_2_2$E1_processemiss + waste_2_2$E1_enduseemiss + waste_2_2$E1_bioco2emiss + waste_2_2$E1_dispemiss
...
waste_2_2$E2_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$E2_tech
...
waste_2_2$E2_netemiss <- waste_2_2$E2_collectionemiss + waste_2_2$E2_transport1emiss + waste_2_2$E2_processemiss + waste_2_2$E2_enduseemiss + waste_2_2$E2_bioco2emiss + waste_2_2$E2_dispemiss
...
waste_2_2$E3_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$E3_tech
...
waste_2_2$E3_netemiss <- waste_2_2$E3_collectionemiss + waste_2_2$E3_transport1emiss + waste_2_2$E3_processemiss + waste_2_2$E3_enduseemiss + waste_2_2$E3_bioco2emiss + waste_2_2$E3_dispemiss
...
waste_2_2$E4_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$E4_tech
...
waste_2_2$E4_netemiss <- waste_2_2$E4_collectionemiss + waste_2_2$E4_transport1emiss + waste_2_2$E4_processemiss + waste_2_2$E4_enduseemiss + waste_2_2$E4_bioco2emiss + waste_2_2$E4_dispemiss
...
waste_2_2$M1_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$M1_tech
waste_2_2$M1_dispemiss <- 0 - waste_2_2$M1_energy* waste_2_2$NG_GHG
waste_2_2$M1_dispemissmain <- waste_2_2$M1_dispemiss
waste_2_2$M1_netemiss <- waste_2_2$M1_collectionemiss + waste_2_2$M1_transport1emiss + waste_2_2$M1_processemiss + waste_2_2$M1_transport2emiss + waste_2_2$M1_enduseemiss + waste_2_2$M1_bioco2emiss + waste_2_2$M1_dispemiss
...
waste_2_2$M2_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$M2_tech
waste_2_2$M2_dispemiss <- 0 - waste_2_2$M2_energy* waste_2_2$NG_GHG
waste_2_2$M2_dispemissmain <- waste_2_2$M2_dispemiss
waste_2_2$M2_netemiss <- waste_2_2$M2_collectionemiss + waste_2_2$M2_transport1emiss + waste_2_2$M2_processemiss + waste_2_2$M2_transport2emiss + waste_2_2$M2_enduseemiss + waste_2_2$M2_bioco2emiss + waste_2_2$M2_dispemiss
...
waste_2_2$Eth1_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$Eth1_tech
...
waste_2_2$Eth1_netemiss <- waste_2_2$Eth1_collectionemiss + waste_2_2$Eth1_transport1emiss + waste_2_2$Eth1_processemiss + waste_2_2$Eth1_transport2emiss + waste_2_2$Eth1_enduseemiss + waste_2_2$Eth1_bioco2emiss + waste_2_2$Eth1_dispemiss
...
waste_2_2$Rd1_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$Rd1_tech
...
waste_2_2$Rd1_dispemissco <- 0 - waste_2_2$Rd1_g * waste_2_2$Gasoline_GHG -  waste_2_2$Rd1_j * waste_2_2$Jet_GHG -
  waste_2_2$Rd1_m * waste_2_2$NG_GHG - waste_2_2$Rd1_elec * waste_2_2$Powergen_GHG 
waste_2_2$Rd1_netemiss <- waste_2_2$Rd1_collectionemiss + waste_2_2$Rd1_transport1emiss + waste_2_2$Rd1_processemiss + waste_2_2$Rd1_enduseemiss + waste_2_2$Rd1_transport2emiss + waste_2_2$Rd1_bioco2emiss + waste_2_2$Rd1_dispemiss
...
waste_2_2$Rd2_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$Rd2_tech
...
waste_2_2$Rd2_netemiss <- waste_2_2$Rd2_collectionemiss + waste_2_2$Rd2_transport1emiss + waste_2_2$Rd2_processemiss + waste_2_2$Rd2_transport2emiss + waste_2_2$Rd2_enduseemiss + waste_2_2$Rd2_bioco2emiss + waste_2_2$Rd2_dispemiss
...
waste_2_2$Bj1_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$Bj1_tech
...
waste_2_2$Bj1_netemiss <- waste_2_2$Bj1_collectionemiss + waste_2_2$Bj1_transport1emiss + waste_2_2$Bj1_processemiss + waste_2_2$Bj1_transport2emiss + waste_2_2$Bj1_enduseemiss + waste_2_2$Bj1_bioco2emiss + waste_2_2$Bj1_dispemiss
...
waste_2_2$Bj2_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$Bj2_tech
waste_2_2$Bj2_dispemiss <- 0 - waste_2_2$Bj2_energy * waste_2_2$Jet_GHG 
waste_2_2$Bj2_dispemissmain <- waste_2_2$Bj2_dispemiss
waste_2_2$Bj2_netemiss <- waste_2_2$Bj2_collectionemiss + waste_2_2$Bj2_transport1emiss + waste_2_2$Bj2_processemiss + waste_2_2$Bj2_transport2emiss + waste_2_2$Bj2_enduseemiss + waste_2_2$Bj2_bioco2emiss + waste_2_2$Bj2_dispemiss
...
waste_2_2$Bj3_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$Bj3_tech
...
waste_2_2$Bj3_netemiss <- waste_2_2$Bj3_collectionemiss + waste_2_2$Bj3_transport1emiss + waste_2_2$Bj3_processemiss + waste_2_2$Bj3_transport2emiss + waste_2_2$Bj3_enduseemiss + waste_2_2$Bj3_bioco2emiss + waste_2_2$Bj3_dispemiss
...
waste_2_2$Bj4_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$Bj4_tech
...
waste_2_2$Bj4_netemiss <- waste_2_2$Bj4_collectionemiss + waste_2_2$Bj4_transport1emiss + waste_2_2$Bj4_processemiss + waste_2_2$Bj4_transport2emiss+ waste_2_2$Bj4_enduseemiss + waste_2_2$Bj4_bioco2emiss + waste_2_2$Bj4_dispemiss
...
waste_2_2$Bj5_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$Bj5_tech
...
waste_2_2$Bj5_netemiss <- waste_2_2$Bj5_collectionemiss + waste_2_2$Bj5_transport1emiss + waste_2_2$Bj5_processemiss + waste_2_2$Bj5_transport2emiss + waste_2_2$Bj5_enduseemiss + waste_2_2$Bj5_bioco2emiss + waste_2_2$Bj5_dispemiss
...
waste_2_2$Bj6_bioco2emiss <- waste_2_2$Prod_ww * waste_2_2$Bio_emiss * waste_2_2$Bj6_tech
...
waste_2_2$Bj6_netemiss <- waste_2_2$Bj6_collectionemiss + waste_2_2$Bj6_transport1emiss + waste_2_2$Bj6_processemiss + waste_2_2$Bj6_transport2emiss + waste_2_2$Bj6_enduseemiss + waste_2_2$Bj6_bioco2emiss + waste_2_2$Bj6_dispemiss
...
ggsave(paste(County_FOLDER, "/US_netemiss_SA_bioco2.png", sep=""), plot=p, width=20,height=6,units="in",dpi=300)
...
waste_2_3$E1_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$E1_tech
...
waste_2_3$E1_netemiss <- waste_2_3$E1_collectionemiss + waste_2_3$E1_transport1emiss + waste_2_3$E1_processemiss + waste_2_3$E1_enduseemiss + waste_2_3$E1_bioco2emiss + waste_2_3$E1_dispemiss
...
waste_2_3$E2_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$E2_tech
...
waste_2_3$E2_netemiss <- waste_2_3$E2_collectionemiss + waste_2_3$E2_transport1emiss + waste_2_3$E2_processemiss + waste_2_3$E2_enduseemiss + waste_2_3$E2_bioco2emiss + waste_2_3$E2_dispemiss
...
waste_2_3$E3_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$E3_tech
...
waste_2_3$E3_netemiss <- waste_2_3$E3_collectionemiss + waste_2_3$E3_transport1emiss + waste_2_3$E3_processemiss + waste_2_3$E3_enduseemiss + waste_2_3$E3_bioco2emiss + waste_2_3$E3_dispemiss
...
waste_2_3$E4_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$E4_tech
...
waste_2_3$E4_netemiss <- waste_2_3$E4_collectionemiss + waste_2_3$E4_transport1emiss + waste_2_3$E4_processemiss + waste_2_3$E4_enduseemiss + waste_2_3$E4_bioco2emiss + waste_2_3$E4_dispemiss
...
waste_2_3$M1_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$M1_tech
waste_2_3$M1_dispemiss <- 0 - waste_2_3$M1_energy* waste_2_3$NG_GHG
waste_2_3$M1_dispemissmain <- waste_2_3$M1_dispemiss
waste_2_3$M1_netemiss <- waste_2_3$M1_collectionemiss + waste_2_3$M1_transport1emiss + waste_2_3$M1_processemiss + waste_2_3$M1_transport2emiss + waste_2_3$M1_enduseemiss + waste_2_3$M1_bioco2emiss + waste_2_3$M1_dispemiss
...
waste_2_3$M2_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$M2_tech
waste_2_3$M2_dispemiss <- 0 - waste_2_3$M2_energy* waste_2_3$NG_GHG
waste_2_3$M2_dispemissmain <- waste_2_3$M2_dispemiss
waste_2_3$M2_netemiss <- waste_2_3$M2_collectionemiss + waste_2_3$M2_transport1emiss + waste_2_3$M2_processemiss + waste_2_3$M2_transport2emiss + waste_2_3$M2_enduseemiss + waste_2_3$M2_bioco2emiss + waste_2_3$M2_dispemiss
...
waste_2_3$Eth1_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$Eth1_tech
...
waste_2_3$Eth1_netemiss <- waste_2_3$Eth1_collectionemiss + waste_2_3$Eth1_transport1emiss + waste_2_3$Eth1_processemiss + waste_2_3$Eth1_transport2emiss + waste_2_3$Eth1_enduseemiss + waste_2_3$Eth1_bioco2emiss + waste_2_3$Eth1_dispemiss
...
waste_2_3$Rd1_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$Rd1_tech
...
waste_2_3$Rd1_dispemissco <- 0 - waste_2_3$Rd1_g * waste_2_3$Gasoline_GHG -  waste_2_3$Rd1_j * waste_2_3$Jet_GHG -
  waste_2_3$Rd1_m * waste_2_3$NG_GHG - waste_2_3$Rd1_elec * waste_2_3$Powergen_GHG 
waste_2_3$Rd1_netemiss <- waste_2_3$Rd1_collectionemiss + waste_2_3$Rd1_transport1emiss + waste_2_3$Rd1_processemiss + waste_2_3$Rd1_enduseemiss + waste_2_3$Rd1_transport2emiss + waste_2_3$Rd1_bioco2emiss + waste_2_3$Rd1_dispemiss
...
waste_2_3$Rd2_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$Rd2_tech
...
waste_2_3$Rd2_netemiss <- waste_2_3$Rd2_collectionemiss + waste_2_3$Rd2_transport1emiss + waste_2_3$Rd2_processemiss + waste_2_3$Rd2_transport2emiss + waste_2_3$Rd2_enduseemiss + waste_2_3$Rd2_bioco2emiss + waste_2_3$Rd2_dispemiss
...
waste_2_3$Bj1_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$Bj1_tech
...
waste_2_3$Bj1_netemiss <- waste_2_3$Bj1_collectionemiss + waste_2_3$Bj1_transport1emiss + waste_2_3$Bj1_processemiss + waste_2_3$Bj1_transport2emiss + waste_2_3$Bj1_enduseemiss + waste_2_3$Bj1_bioco2emiss + waste_2_3$Bj1_dispemiss
...
waste_2_3$Bj2_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$Bj2_tech
waste_2_3$Bj2_dispemiss <- 0 - waste_2_3$Bj2_energy * waste_2_3$Jet_GHG 
waste_2_3$Bj2_dispemissmain <- waste_2_3$Bj2_dispemiss
waste_2_3$Bj2_netemiss <- waste_2_3$Bj2_collectionemiss + waste_2_3$Bj2_transport1emiss + waste_2_3$Bj2_processemiss + waste_2_3$Bj2_transport2emiss + waste_2_3$Bj2_enduseemiss + waste_2_3$Bj2_bioco2emiss + waste_2_3$Bj2_dispemiss
...
waste_2_3$Bj3_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$Bj3_tech
...
waste_2_3$Bj3_netemiss <- waste_2_3$Bj3_collectionemiss + waste_2_3$Bj3_transport1emiss + waste_2_3$Bj3_processemiss + waste_2_3$Bj3_transport2emiss + waste_2_3$Bj3_enduseemiss + waste_2_3$Bj3_bioco2emiss + waste_2_3$Bj3_dispemiss
...
waste_2_3$Bj4_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$Bj4_tech
...
waste_2_3$Bj4_netemiss <- waste_2_3$Bj4_collectionemiss + waste_2_3$Bj4_transport1emiss + waste_2_3$Bj4_processemiss + waste_2_3$Bj4_transport2emiss+ waste_2_3$Bj4_enduseemiss + waste_2_3$Bj4_bioco2emiss + waste_2_3$Bj4_dispemiss
...
waste_2_3$Bj5_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$Bj5_tech
...
waste_2_3$Bj5_netemiss <- waste_2_3$Bj5_collectionemiss + waste_2_3$Bj5_transport1emiss + waste_2_3$Bj5_processemiss + waste_2_3$Bj5_transport2emiss + waste_2_3$Bj5_enduseemiss + waste_2_3$Bj5_bioco2emiss + waste_2_3$Bj5_dispemiss
...
waste_2_3$Bj6_bioco2emiss <- waste_2_3$Prod_ww * waste_2_3$Bio_emiss * waste_2_3$Bj6_tech
...
waste_2_3$Bj6_netemiss <- waste_2_3$Bj6_collectionemiss + waste_2_3$Bj6_transport1emiss + waste_2_3$Bj6_processemiss + waste_2_3$Bj6_transport2emiss + waste_2_3$Bj6_enduseemiss + waste_2_3$Bj6_bioco2emiss + waste_2_3$Bj6_dispemiss
...
waste_2_4$E1_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$E1_tech
...
waste_2_4$E1_netemiss <- waste_2_4$E1_collectionemiss + waste_2_4$E1_transport1emiss + waste_2_4$E1_processemiss + waste_2_4$E1_enduseemiss + waste_2_4$E1_bioco2emiss + waste_2_4$E1_dispemiss
...
waste_2_4$E2_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$E2_tech
...
waste_2_4$E2_netemiss <- waste_2_4$E2_collectionemiss + waste_2_4$E2_transport1emiss + waste_2_4$E2_processemiss + waste_2_4$E2_enduseemiss + waste_2_4$E2_bioco2emiss + waste_2_4$E2_dispemiss
...
waste_2_4$E3_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$E3_tech
...
waste_2_4$E3_netemiss <- waste_2_4$E3_collectionemiss + waste_2_4$E3_transport1emiss + waste_2_4$E3_processemiss + waste_2_4$E3_enduseemiss + waste_2_4$E3_bioco2emiss + waste_2_4$E3_dispemiss
...
waste_2_4$E4_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$E4_tech
...
waste_2_4$E4_netemiss <- waste_2_4$E4_collectionemiss + waste_2_4$E4_transport1emiss + waste_2_4$E4_processemiss + waste_2_4$E4_enduseemiss + waste_2_4$E4_bioco2emiss + waste_2_4$E4_dispemiss
...
waste_2_4$M1_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$M1_tech
waste_2_4$M1_dispemiss <- 0 - waste_2_4$M1_energy* waste_2_4$NG_GHG
waste_2_4$M1_dispemissmain <- waste_2_4$M1_dispemiss
waste_2_4$M1_netemiss <- waste_2_4$M1_collectionemiss + waste_2_4$M1_transport1emiss + waste_2_4$M1_processemiss + waste_2_4$M1_transport2emiss + waste_2_4$M1_enduseemiss + waste_2_4$M1_bioco2emiss + waste_2_4$M1_dispemiss
...
waste_2_4$M2_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$M2_tech
waste_2_4$M2_dispemiss <- 0 - waste_2_4$M2_energy* waste_2_4$NG_GHG
waste_2_4$M2_dispemissmain <- waste_2_4$M2_dispemiss
waste_2_4$M2_netemiss <- waste_2_4$M2_collectionemiss + waste_2_4$M2_transport1emiss + waste_2_4$M2_processemiss + waste_2_4$M2_transport2emiss + waste_2_4$M2_enduseemiss + waste_2_4$M2_bioco2emiss + waste_2_4$M2_dispemiss
...
waste_2_4$Eth1_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$Eth1_tech
...
waste_2_4$Eth1_netemiss <- waste_2_4$Eth1_collectionemiss + waste_2_4$Eth1_transport1emiss + waste_2_4$Eth1_processemiss + waste_2_4$Eth1_transport2emiss + waste_2_4$Eth1_enduseemiss + waste_2_4$Eth1_bioco2emiss + waste_2_4$Eth1_dispemiss
...
waste_2_4$Rd1_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$Rd1_tech
...
waste_2_4$Rd1_dispemissco <- 0 - waste_2_4$Rd1_g * waste_2_4$Gasoline_GHG -  waste_2_4$Rd1_j * waste_2_4$Jet_GHG -
  waste_2_4$Rd1_m * waste_2_4$NG_GHG - waste_2_4$Rd1_elec * waste_2_4$Powergen_GHG 
waste_2_4$Rd1_netemiss <- waste_2_4$Rd1_collectionemiss + waste_2_4$Rd1_transport1emiss + waste_2_4$Rd1_processemiss + waste_2_4$Rd1_enduseemiss + waste_2_4$Rd1_transport2emiss + waste_2_4$Rd1_bioco2emiss + waste_2_4$Rd1_dispemiss
...
waste_2_4$Rd2_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$Rd2_tech
...
waste_2_4$Rd2_netemiss <- waste_2_4$Rd2_collectionemiss + waste_2_4$Rd2_transport1emiss + waste_2_4$Rd2_processemiss + waste_2_4$Rd2_transport2emiss + waste_2_4$Rd2_enduseemiss + waste_2_4$Rd2_bioco2emiss + waste_2_4$Rd2_dispemiss
...
waste_2_4$Bj1_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$Bj1_tech
...
waste_2_4$Bj1_netemiss <- waste_2_4$Bj1_collectionemiss + waste_2_4$Bj1_transport1emiss + waste_2_4$Bj1_processemiss + waste_2_4$Bj1_transport2emiss + waste_2_4$Bj1_enduseemiss + waste_2_4$Bj1_bioco2emiss + waste_2_4$Bj1_dispemiss
...
waste_2_4$Bj2_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$Bj2_tech
waste_2_4$Bj2_dispemiss <- 0 - waste_2_4$Bj2_energy * waste_2_4$Jet_GHG 
waste_2_4$Bj2_dispemissmain <- waste_2_4$Bj2_dispemiss
waste_2_4$Bj2_netemiss <- waste_2_4$Bj2_collectionemiss + waste_2_4$Bj2_transport1emiss + waste_2_4$Bj2_processemiss + waste_2_4$Bj2_transport2emiss + waste_2_4$Bj2_enduseemiss + waste_2_4$Bj2_bioco2emiss + waste_2_4$Bj2_dispemiss
...
waste_2_4$Bj3_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$Bj3_tech
...
waste_2_4$Bj3_netemiss <- waste_2_4$Bj3_collectionemiss + waste_2_4$Bj3_transport1emiss + waste_2_4$Bj3_processemiss + waste_2_4$Bj3_transport2emiss + waste_2_4$Bj3_enduseemiss + waste_2_4$Bj3_bioco2emiss + waste_2_4$Bj3_dispemiss
...
waste_2_4$Bj4_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$Bj4_tech
...
waste_2_4$Bj4_netemiss <- waste_2_4$Bj4_collectionemiss + waste_2_4$Bj4_transport1emiss + waste_2_4$Bj4_processemiss + waste_2_4$Bj4_transport2emiss+ waste_2_4$Bj4_enduseemiss + waste_2_4$Bj4_bioco2emiss + waste_2_4$Bj4_dispemiss
...
waste_2_4$Bj5_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$Bj5_tech
...
waste_2_4$Bj5_netemiss <- waste_2_4$Bj5_collectionemiss + waste_2_4$Bj5_transport1emiss + waste_2_4$Bj5_processemiss + waste_2_4$Bj5_transport2emiss + waste_2_4$Bj5_enduseemiss + waste_2_4$Bj5_bioco2emiss + waste_2_4$Bj5_dispemiss
...
waste_2_4$Bj6_bioco2emiss <- waste_2_4$Prod_ww * waste_2_4$Bio_emiss * waste_2_4$Bj6_tech
...
waste_2_4$Bj6_netemiss <- waste_2_4$Bj6_collectionemiss + waste_2_4$Bj6_transport1emiss + waste_2_4$Bj6_processemiss + waste_2_4$Bj6_transport2emiss + waste_2_4$Bj6_enduseemiss + waste_2_4$Bj6_bioco2emiss + waste_2_4$Bj6_dispemiss
...
waste_2_5$E1_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$E1_tech
...
waste_2_5$E1_netemiss <- waste_2_5$E1_collectionemiss + waste_2_5$E1_transport1emiss + waste_2_5$E1_processemiss + waste_2_5$E1_enduseemiss + waste_2_5$E1_bioco2emiss + waste_2_5$E1_dispemiss
...
waste_2_5$E2_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$E2_tech
...
waste_2_5$E2_netemiss <- waste_2_5$E2_collectionemiss + waste_2_5$E2_transport1emiss + waste_2_5$E2_processemiss + waste_2_5$E2_enduseemiss + waste_2_5$E2_bioco2emiss + waste_2_5$E2_dispemiss
...
waste_2_5$E3_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$E3_tech
...
waste_2_5$E3_netemiss <- waste_2_5$E3_collectionemiss + waste_2_5$E3_transport1emiss + waste_2_5$E3_processemiss + waste_2_5$E3_enduseemiss + waste_2_5$E3_bioco2emiss + waste_2_5$E3_dispemiss
...
waste_2_5$E4_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$E4_tech
...
waste_2_5$E4_netemiss <- waste_2_5$E4_collectionemiss + waste_2_5$E4_transport1emiss + waste_2_5$E4_processemiss + waste_2_5$E4_enduseemiss + waste_2_5$E4_bioco2emiss + waste_2_5$E4_dispemiss
...
waste_2_5$M1_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$M1_tech
waste_2_5$M1_dispemiss <- 0 - waste_2_5$M1_energy* waste_2_5$NG_GHG
waste_2_5$M1_dispemissmain <- waste_2_5$M1_dispemiss
waste_2_5$M1_netemiss <- waste_2_5$M1_collectionemiss + waste_2_5$M1_transport1emiss + waste_2_5$M1_processemiss + waste_2_5$M1_transport2emiss + waste_2_5$M1_enduseemiss + waste_2_5$M1_bioco2emiss + waste_2_5$M1_dispemiss
...
waste_2_5$M2_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$M2_tech
waste_2_5$M2_dispemiss <- 0 - waste_2_5$M2_energy* waste_2_5$NG_GHG
waste_2_5$M2_dispemissmain <- waste_2_5$M2_dispemiss
waste_2_5$M2_netemiss <- waste_2_5$M2_collectionemiss + waste_2_5$M2_transport1emiss + waste_2_5$M2_processemiss + waste_2_5$M2_transport2emiss + waste_2_5$M2_enduseemiss + waste_2_5$M2_bioco2emiss + waste_2_5$M2_dispemiss
...
waste_2_5$Eth1_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$Eth1_tech
...
waste_2_5$Eth1_netemiss <- waste_2_5$Eth1_collectionemiss + waste_2_5$Eth1_transport1emiss + waste_2_5$Eth1_processemiss + waste_2_5$Eth1_transport2emiss + waste_2_5$Eth1_enduseemiss + waste_2_5$Eth1_bioco2emiss + waste_2_5$Eth1_dispemiss
...
waste_2_5$Rd1_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$Rd1_tech
...
waste_2_5$Rd1_dispemissco <- 0 - waste_2_5$Rd1_g * waste_2_5$Gasoline_GHG -  waste_2_5$Rd1_j * waste_2_5$Jet_GHG -
  waste_2_5$Rd1_m * waste_2_5$NG_GHG - waste_2_5$Rd1_elec * waste_2_5$Powergen_GHG 
waste_2_5$Rd1_netemiss <- waste_2_5$Rd1_collectionemiss + waste_2_5$Rd1_transport1emiss + waste_2_5$Rd1_processemiss + waste_2_5$Rd1_enduseemiss + waste_2_5$Rd1_transport2emiss + waste_2_5$Rd1_bioco2emiss + waste_2_5$Rd1_dispemiss
...
waste_2_5$Rd2_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$Rd2_tech
...
waste_2_5$Rd2_netemiss <- waste_2_5$Rd2_collectionemiss + waste_2_5$Rd2_transport1emiss + waste_2_5$Rd2_processemiss + waste_2_5$Rd2_transport2emiss + waste_2_5$Rd2_enduseemiss + waste_2_5$Rd2_bioco2emiss + waste_2_5$Rd2_dispemiss
...
waste_2_5$Bj1_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$Bj1_tech
...
waste_2_5$Bj1_netemiss <- waste_2_5$Bj1_collectionemiss + waste_2_5$Bj1_transport1emiss + waste_2_5$Bj1_processemiss + waste_2_5$Bj1_transport2emiss + waste_2_5$Bj1_enduseemiss + waste_2_5$Bj1_bioco2emiss + waste_2_5$Bj1_dispemiss
...
waste_2_5$Bj2_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$Bj2_tech
waste_2_5$Bj2_dispemiss <- 0 - waste_2_5$Bj2_energy * waste_2_5$Jet_GHG 
waste_2_5$Bj2_dispemissmain <- waste_2_5$Bj2_dispemiss
waste_2_5$Bj2_netemiss <- waste_2_5$Bj2_collectionemiss + waste_2_5$Bj2_transport1emiss + waste_2_5$Bj2_processemiss + waste_2_5$Bj2_transport2emiss + waste_2_5$Bj2_enduseemiss + waste_2_5$Bj2_bioco2emiss + waste_2_5$Bj2_dispemiss
...
waste_2_5$Bj3_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$Bj3_tech
...
waste_2_5$Bj3_netemiss <- waste_2_5$Bj3_collectionemiss + waste_2_5$Bj3_transport1emiss + waste_2_5$Bj3_processemiss + waste_2_5$Bj3_transport2emiss + waste_2_5$Bj3_enduseemiss + waste_2_5$Bj3_bioco2emiss + waste_2_5$Bj3_dispemiss
...
waste_2_5$Bj4_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$Bj4_tech
...
waste_2_5$Bj4_netemiss <- waste_2_5$Bj4_collectionemiss + waste_2_5$Bj4_transport1emiss + waste_2_5$Bj4_processemiss + waste_2_5$Bj4_transport2emiss+ waste_2_5$Bj4_enduseemiss + waste_2_5$Bj4_bioco2emiss + waste_2_5$Bj4_dispemiss
...
waste_2_5$Bj5_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$Bj5_tech
...
waste_2_5$Bj5_netemiss <- waste_2_5$Bj5_collectionemiss + waste_2_5$Bj5_transport1emiss + waste_2_5$Bj5_processemiss + waste_2_5$Bj5_transport2emiss + waste_2_5$Bj5_enduseemiss + waste_2_5$Bj5_bioco2emiss + waste_2_5$Bj5_dispemiss
...
waste_2_5$Bj6_bioco2emiss <- waste_2_5$Prod_ww * waste_2_5$Bio_emiss * waste_2_5$Bj6_tech
...
waste_2_5$Bj6_netemiss <- waste_2_5$Bj6_collectionemiss + waste_2_5$Bj6_transport1emiss + waste_2_5$Bj6_processemiss + waste_2_5$Bj6_transport2emiss + waste_2_5$Bj6_enduseemiss + waste_2_5$Bj6_bioco2emiss + waste_2_5$Bj6_dispemiss
...
#  theme(plot.title = element_text(face = "bold", size = 24, hjust = 0))
ggsave(paste(County_FOLDER, "/US_netemiss_SA_TD_bioco2.png", sep=""), plot=p, width=20,height=6,units="in",dpi=300)
